...
const features = [
  {
    ...
    description: "Real-time market data with interactive charts and sector analysis",
  ...
  },
  {
    ...
    description: "AI-powered personality analysis for stocks with confidence scores",
  ...
  },
  {
    ...
    description: "Comprehensive financial data, ratios, and historical analysis",
  ...
  },
  {
    ...
    description: "Interactive traders' hub for discussions, doubt-solving, and strategy sharing",
    href: "/community",
    available: true,
  },
]
          ...
          <div className="flex items-center space-x-8 text-sm">
            {tickerData.map((item, index) => (
              <div key={index} className="flex items-center space-x-2 whitespace-nowrap">
                ...
                <span className={`font-medium ${item.positive ? "text-teal-400" : "text-red-400"}`}>{item.change}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Harness the power of AI to make informed trading decisions with real-time market analysis, sentiment
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Powerful Trading Tools</h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Everything you need to make smarter trading decisions, powered by advanced AI and real-time data.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    >
                      <IconComponent className={`w-6 h-6 ${feature.available ? "text-teal-400" : "text-slate-500"}`} />
                    </div>

                    {!feature.available && (
                      <span className="text-xs bg-slate-700 text-slate-400 px-2 py-1 rounded-full">Coming Soon</span>
                    )}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-slate-400">AI-powered financial intelligence for smarter trading decisions.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                {features.slice(3).map((feature) => (
                  <li key={feature.title}>
                    <a href={feature.href} className="hover:text-teal-400 transition-colors">
                      {feature.title}
                    </a>
                  </li>
                ))}
